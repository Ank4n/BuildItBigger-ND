 ...
 * on 2016-05-30 at 13:57:30 UTC 
 * Modify at your own risk.
 */

package space.ankan.builditbigger.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getGoodJoke".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link GetGoodJoke#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public GetGoodJoke getGoodJoke() throws java.io.IOException {
    GetGoodJoke result = new GetGoodJoke();
    initialize(result);
    return result;
  }

  public class GetGoodJoke extends MyApiRequest<space.ankan.builditbigger.backend.myApi.model.MyBean> {
     ...
     * parameters, call the {@link GetGoodJoke#execute()} method to invoke the remote operation. <p>
     * {@link
     * GetGoodJoke#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected GetGoodJoke() {
      super(MyApi.this, "GET", REST_PATH, null, space.ankan.builditbigger.backend.myApi.model.MyBean.class);
    }
    ...
    @Override
    public GetGoodJoke setAlt(java.lang.String alt) {
      return (GetGoodJoke) super.setAlt(alt);
    }

    @Override
    public GetGoodJoke setFields(java.lang.String fields) {
      return (GetGoodJoke) super.setFields(fields);
    }

    @Override
    public GetGoodJoke setKey(java.lang.String key) {
      return (GetGoodJoke) super.setKey(key);
    }

    @Override
    public GetGoodJoke setOauthToken(java.lang.String oauthToken) {
      return (GetGoodJoke) super.setOauthToken(oauthToken);
    }

    @Override
    public GetGoodJoke setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetGoodJoke) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetGoodJoke setQuotaUser(java.lang.String quotaUser) {
      return (GetGoodJoke) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetGoodJoke setUserIp(java.lang.String userIp) {
      return (GetGoodJoke) super.setUserIp(userIp);
    }

    @Override
    public GetGoodJoke set(String parameterName, Object value) {
      return (GetGoodJoke) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<space.ankan.builditbigger.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, space.ankan.builditbigger.backend.myApi.model.MyBean.class);
